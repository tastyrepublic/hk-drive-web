...
import { useBlocker } from 'react-router'; // <-- Added useBlocker
...
export function ProfileView({ 
  ...
  const isModified = isEditing && newName !== userProfile?.name;
  ...
  return (
    <>
      ...
      <UnsavedChangesBar 
        ...
        onDiscard={() => {
            setNewName(userProfile?.name); // Revert changes
      ...
      <div className="pb-20 grid grid-cols-1 md:grid-cols-2 gap-6 relative z-0">
